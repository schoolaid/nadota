...
abstract class Resource implements Contracts\ResourceInterface
{
    ...
    /**
     * Hook called before permanently deleting a soft-deleted resource
     * Override this method to perform custom logic before force deletion
     */
     ...
     *
     * @return bool True if force delete was successful, false otherwise
     */
    ...
    /**
     * Hook called after successfully force deleting a resource
     * Override this method to perform custom logic after force deletion
     */
