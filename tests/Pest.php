...
expect()->extend('toHaveFieldAttribute', function (string $attribute) {
    return $this->and($this->value->getAttribute())->toBe($attribute);
});

expect()->extend('toBeFieldType', function (string $type) {
    return $this->and($this->value->getType()->value)->toBe($type);
});
